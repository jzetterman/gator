...
SELECT feed_follow.id, feed_follow.created_at, feed_follow.updated_at, feed_follow.feed_id, feed_follow.user_id, feeds.name AS feed_name, users.name AS user_name
FROM feed_follow
